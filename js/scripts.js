...
const firebaseConfig = {
    ...
    databaseURL: "https://cinistudios-default-rtdb.asia-southeast1.firebasedatabase.app"
};
...
$("#main-register-form2").on("submit", function (e){
    e.preventDefault();
    var name =  document.getElementById("main-register-form2").elements['name'].value;
    var email =  document.getElementById("main-register-form2").elements['email'].value;
    var password =  document.getElementById("main-register-form2").elements["password"].value;
...
email = document.getElementById('main-register-form').elements['email'].value
password = document.getElementById('main-register-form').elements['password'].value
